...
export const metadata = {
  title: 'Movies - Explore Featured, Trending, and More',
  description: 'Discover the best movies. Browse featured content, top 10 lists, trending films, new releases, and upcoming attractions.',
  alternates: {
    canonical: '/movies',
  },
};
