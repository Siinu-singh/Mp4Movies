...
export default function LiveTvSearch({ onSearchChange, searchTerm }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Actual search submission logic would be handled by parent via onSearchChange prop
    ...
    >
      ...
      >
        <motion.div
          ...
          aria-hidden="true"
        >
          <div className="w-full h-full rounded-full bg-gradient-to-r from-primary via-orange-500 to-accent" />
        </motion.div>
